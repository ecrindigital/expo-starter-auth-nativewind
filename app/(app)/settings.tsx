      ...
      <View className="px-4 py-6">
        ...
        <View className="bg-white rounded-xl mb-6">
          ...
          <SettingItem
            ...
            onPress={() => Alert.alert('Change Password', 'Password change screen would appear here')}
          />
          <View className="h-px bg-gray-100 mx-4" />
          <SettingItem
            icon="shield-checkmark-outline"
            title="Privacy Settings"
            onPress={() => Alert.alert('Privacy Settings', 'Privacy settings screen would appear here')}
          />
        </View>
