    ...
    <ScrollView className="flex-1 bg-white">
      <View className="p-6">
        <View className="bg-indigo-50 rounded-xl p-5 mb-6">
          <Text className="text-xl font-bold text-indigo-800 mb-2">
          ...
          <View className="bg-white p-4 rounded-lg">
            ...
            <Text className="font-semibold mb-2">{user?.email || 'Unknown'}</Text>
        ...
        <View className="space-y-4 mb-8">
          <View className="bg-gray-50 p-4 rounded-lg">
            ...
            <Text className="text-gray-600">
              The app includes a complete authentication flow with login, registration, and session management.
            </Text>
          </View>
